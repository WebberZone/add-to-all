...
<div class="postbox-container">
	<div id="pro-upgrade-banner">
		<div class="inside">
			<p><a href="https://wzn.io/donate-bs" target="_blank"><img src="<?php echo esc_url( WZ_SNIPPETZ_URL . 'includes/admin/images/support.webp' ); ?>" alt="<?php esc_html_e( 'Support the development - Send us a donation today.', 'knowledgebase' ); ?>" width="300" height="169" style="max-width: 100%;" /></a></p>
		</div>
	</div>
		...
		<div class="inside">
			<div id="quick-links">
				<ul class="subsub">
					...
					<li><a href="https://webberzone.com/plugins/knowledgebase/" target="_blank"><?php esc_html_e( 'WebberZone Knowledge Base', 'knowledgebase' ); ?></a></li>
