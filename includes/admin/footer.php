...
<div class="postbox-container">
	<div id="donatediv" class="postbox meta-box-sortables">
	  <h2 class='hndle'><span><?php esc_attr_e( 'Support the development', 'add-to-all' ); ?></span></h3>
	  <div class="inside" style="text-align: center">
		<div id="donate-form">
			...
			<input type="hidden" name="item_name" value="<?php esc_attr_e( 'Donation for Add to All', 'add-to-all' ); ?>">
			<input type="hidden" name="item_number" value="crp_plugin_settings">
			<strong><?php esc_attr_e( 'Enter amount in USD', 'add-to-all' ); ?>:</strong> <input name="amount" value="10.00" size="6" type="text"><br />
			<input type="hidden" name="currency_code" value="USD">
			<input type="hidden" name="button_subtype" value="services">
			<input type="hidden" name="bn" value="PP-BuyNowBF:btn_donate_LG.gif:NonHosted">
			<input type="image" src="https://www.paypal.com/en_US/i/btn/btn_donate_LG.gif" border="0" name="submit" alt="<?php esc_attr_e( 'Send your donation to the author of Add to All', 'add-to-all' ); ?>">
