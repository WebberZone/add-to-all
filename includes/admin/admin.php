 ...
 */
function ata_load_admin_scripts( $hook ) {

	global $ata_settings_page;

	if ( $hook !== $ata_settings_page ) {
		return;
	}
	...
	wp_enqueue_script( 'ata-admin-js', ATA_PLUGIN_URL . 'includes/admin/js/admin-scripts.min.js', array( 'jquery' ), '1.0', true );
}
add_action( 'admin_enqueue_scripts', 'ata_load_admin_scripts' );
