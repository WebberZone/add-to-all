...
function ata_get_registered_settings() {
	...
	$ata_settings = array(
		'third_party' => ata_settings_third_party(),
		'head'        => ata_settings_head(),
		'content'     => ata_settings_content(),
		'footer'      => ata_settings_footer(),
		'feed'        => ata_settings_feed(),
	);
 ...
 */
function ata_settings_third_party() {
