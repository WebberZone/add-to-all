...
<div class="wrap">
	<h2><?php _e( 'Add to All', ATA_LOCAL_NAME ); ?></h2>
	<div id="poststuff">
	<div id="post-body" class="metabox-holder columns-2">
	<div id="post-body-content">
	  <div id="options-div">
	  <form method="post" id="ata_options" name="ata_options" onsubmit="return checkForm()">
	    <div id="thirdpartydiv" class="postbox closed"><div class="handlediv" title="<?php _e( 'Click to toggle', ATA_LOCAL_NAME ); ?>"><br /></div>
	    ...
	    <div id="headeropdiv" class="postbox closed"><div class="handlediv" title="<?php _e( 'Click to toggle', ATA_LOCAL_NAME ); ?>"><br /></div>
	    ...
	    <div id="contentopdiv" class="postbox closed"><div class="handlediv" title="<?php _e( 'Click to toggle', ATA_LOCAL_NAME ); ?>"><br /></div>
	    ...
	    <div id="footeropdiv" class="postbox closed"><div class="handlediv" title="<?php _e( 'Click to toggle', ATA_LOCAL_NAME ); ?>"><br /></div>
	    ...
	    <div id="feedopdiv" class="postbox closed"><div class="handlediv" title="<?php _e( 'Click to toggle', ATA_LOCAL_NAME ); ?>"><br /></div>
	...
	<div id="postbox-container-1" class="postbox-container">
	  <div id="side-sortables" class="meta-box-sortables ui-sortable">
	    <div id="donatediv" class="postbox"><div class="handlediv" title="<?php _e( 'Click to toggle', ATA_LOCAL_NAME ); ?>"><br /></div>
	    ...
	    <div id="followdiv" class="postbox"><div class="handlediv" title="<?php _e( 'Click to toggle', ATA_LOCAL_NAME ); ?>"><br /></div>
	    ...
	    <div id="qlinksdiv" class="postbox"><div class="handlediv" title="<?php _e( 'Click to toggle', ATA_LOCAL_NAME ); ?>"><br /></div>
	      ...
	      <div class="inside">
	        <div id="quick-links">
				<ul>
					...
					<li><a href="https://wordpress.org/support/plugin/add-to-all"><?php _e( 'Support', ATA_LOCAL_NAME ); ?></a></li>
